...
public class searchForBranch extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewBranches.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(searchForBranch.this, "Branch "+ branch.getName() +" Selected",
        ...
        databaseBranch.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                branchAdaptor = new BranchList(searchForBranch.this, branchesOffered);
    ...
    public boolean onQueryTextSubmit(String search){
        searchKey=search;
        branchAdaptor.addressSearchHelp(searchKey);
        return false;
    }
